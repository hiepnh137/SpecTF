...
from exp.exp_long_term_forecasting_SpecTF import Exp_Long_Term_Forecast_SpecTF
...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', type=str, default='mm-tsf', help='your token of huggingface;need for llama3')
    parser.add_argument('--n_ts_features', type=int, default=0, help='use full model or just encoder')
    parser.add_argument('--text_emb', type=int, default=6, help='use full model or just encoder')
    parser.add_argument('--llm_path', type=str, help='use full model or just encoder')
    parser.add_argument('--dominance_freq', type=int, default=0, help='use full model or just encoder')
    parser.add_argument('--freq_cut_off_rate', type=float, default=1, help='use full model or just encoder')
    parser.add_argument('--proj_per_freq', action='store_true', help='whether to output attention in ecoder')
    parser.add_argument('--text_name', type=str, default='fact', help='your token of huggingface;need for llama3')

    parser.add_argument('--feat_start_id', type=int, default=1, help='use full model or just encoder')
    parser.add_argument('--feat_end_id', type=int, default=4, help='use full model or just encoder')
    parser.add_argument('--mm_emb_size', type=int, default=32, help='use full model or just encoder')
    parser.add_argument('--mm_hidden_size', type=int, default=16, help='use full model or just encoder')
    parser.add_argument('--llm_emb_size', type=int, default=768, help='use full model or just encoder')
    parser.add_argument('--text_dropout', type=float, default=0.3, help='use full model or just encoder')
    parser.add_argument('--fuse_history', action='store_true', help='whether to output attention in ecoder')
    parser.add_argument('--fuse_prediction', action='store_true', help='whether to output attention in ecoder')
    parser.add_argument('--use_product', action='store_true', help='whether to output attention in ecoder')
    parser.add_argument('--only_text_input', action='store_true', help='whether to output attention in ecoder')
    parser.add_argument('--sum_fusion', action='store_true', help='whether to output attention in ecoder')
    ...
    if args.method == 'mm-tsf':
        if args.task_name == 'long_term_forecast':
            ...
            Exp = Exp_Long_Term_Forecast
    elif args.method == 'SpecTF':
        Exp = Exp_Long_Term_Forecast_SpecTF
